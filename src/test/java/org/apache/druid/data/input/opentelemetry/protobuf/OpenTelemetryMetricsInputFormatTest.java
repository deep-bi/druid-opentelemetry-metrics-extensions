...
public class OpenTelemetryMetricsInputFormatTest {
    ...
    public void testSerde() throws Exception {
        OpenTelemetryMetricsProtobufInputFormat inputFormat =
                new OpenTelemetryMetricsProtobufInputFormat("metric.name", "raw.value", "descriptor.", "custom.");

        final ObjectMapper jsonMapper = new ObjectMapper();
        jsonMapper.registerModules(new OpenTelemetryProtobufExtensionsModule().getJacksonModules());

        final OpenTelemetryMetricsProtobufInputFormat actual = (OpenTelemetryMetricsProtobufInputFormat)
                jsonMapper.readValue(jsonMapper.writeValueAsString(inputFormat), InputFormat.class);
    ...
    public void testDefaults() {
        OpenTelemetryMetricsProtobufInputFormat inputFormat =
                new OpenTelemetryMetricsProtobufInputFormat(null, null, null, null);
