...
public class OpenTelemetryMetricsProtobufReaderTest {
    private static final long TIMESTAMP = TimeUnit.MILLISECONDS.toNanos(
            Instant.parse("2019-07-12T09:30:01.123Z").toEpochMilli());
    ...
    private final Metric.Builder metricBuilder = metricsDataBuilder
    ...
    public void testSumWithAttributesFromProtoFile() throws IOException {
        ...
        CloseableIterator<InputRow> rows = new OpenTelemetryMetricsProtobufReader(
                        dimensionsSpec, settableByteEntity, "metric.name", "raw.value", "descriptor.", "custom.")
                .read();
    ...
    public void testSumWithAttributes() {
        metricBuilder
                ...
                .setValue(AnyValue.newBuilder()
                        .setStringValue(METRIC_ATTRIBUTE_VALUE_RED)
                        .build());
    ...
    public void testBatchedMetricParse() {
        ...
        Metric.Builder gaugeMetricBuilder = metricsDataBuilder
                .addResourceMetricsBuilder()
                .addScopeMetricsBuilder()
                .addMetricsBuilder();

        metricsDataBuilder
                .getResourceMetricsBuilder(1)
                .getResourceBuilder()
                .addAttributes(KeyValue.newBuilder()
        ...
        gaugeMetricBuilder
                ...
                .setValue(AnyValue.newBuilder()
                        .setStringValue(METRIC_ATTRIBUTE_FOO_VAL)
                        .build());
    ...
    public void testDimensionSpecExclusions() {
        metricsDataBuilder
                ...
                .setKey(RESOURCE_ATTRIBUTE_ENV)
                .setValue(AnyValue.newBuilder()
                        .setStringValue(RESOURCE_ATTRIBUTE_VALUE_DEVEL)
                        .build());
        ...
        DimensionsSpec dimensionsSpecWithExclusions = DimensionsSpec.builder()
                .setDimensionExclusions(ImmutableList.of(
                        "descriptor." + METRIC_ATTRIBUTE_COLOR, "custom." + RESOURCE_ATTRIBUTE_COUNTRY))
                .build();
